...
(function (r) {
    r.fn.qrcode = function (h) {
        ...
        h = r.extend({}, {render: "canvas", width: 256, height: 256, typeNumber: -1,
            correctLevel: 2, background: "#fbf7eb", foreground: "#4e3922"}, h);
        return this.each(function () {
            ...
            if ("canvas" == h.render) {
                ...
                a.addData(h.text);
                a.make();
                c = r("<table></table>").css("width", h.width + "px").css("height", h.height + "px").css("border", "3px").css("border-collapse", "collapse").css("background-color", h.background);
